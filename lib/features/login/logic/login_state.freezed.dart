...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loginLoading,TResult Function( String message)?  loginSuccess,TResult Function( AppFailure appFailure)?  loginFailure,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case LoginLoading() when loginLoading != null:
return loginLoading();case LoginSuccess() when loginSuccess != null:
return loginSuccess(_that.message);case LoginFailure() when loginFailure != null:
return loginFailure(_that.appFailure);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loginLoading,required TResult Function( String message)  loginSuccess,required TResult Function( AppFailure appFailure)  loginFailure,}) {final _that = this;
switch (_that) {
case _Initial():
return initial();case LoginLoading():
return loginLoading();case LoginSuccess():
return loginSuccess(_that.message);case LoginFailure():
return loginFailure(_that.appFailure);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loginLoading,TResult? Function( String message)?  loginSuccess,TResult? Function( AppFailure appFailure)?  loginFailure,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case LoginLoading() when loginLoading != null:
return loginLoading();case LoginSuccess() when loginSuccess != null:
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LoginSuccess&&(identical(other.message, message) || other.message == message));
}
...
class LoginFailure implements LoginState {
  const LoginFailure(this.appFailure);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LoginFailure&&(identical(other.appFailure, appFailure) || other.appFailure == appFailure));
}
...
@override
String toString() {
  return 'LoginState.loginFailure(appFailure: $appFailure)';
}
